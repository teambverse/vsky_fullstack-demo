...
class DateHelper{
  ...
  static final _timegetHour = DateFormat("mm", _locale);
  static final _timegetMinute = DateFormat("mm", _locale);
  static final _timegetAMPM= DateFormat("aa", _locale);
  ...
  static final _americanStyleDate = DateFormat("MM/dd/yyyy", _locale);
  static final _dateFormatetoMonth = DateFormat("MMMM", _locale);
  ...
  static final _calenderMothYearDate = DateFormat("MMM, yyyy", _locale);
  static final _calenderFullDate = DateFormat("dd MMM, yyyy", _locale);
  ...
  static final _chatTime = DateFormat("hh:mm a", _locale);
  ...
  static String getAiChatTime(DateTime date) {
  ...
  static String getAmericanDate(DateTime? date){
    if(date == null){
      return "No Date Here";
    }
    else{
      return _americanStyleDate.format(date);
    }
  }
  ...
  static String getHour(String? time){
    ...
    DateTime date = _timeFormat12.parse(time);
    return _timegetHour.format(date);
  }
  ...
  static String getMinute(String? time){
    ...
    DateTime date = _timeFormat12.parse(time);
    return _timegetMinute.format(date);
  }
  ...
  static String getAMPM(String? time){
    ...
    DateTime date = _timeFormat12.parse(time);
    return _timegetAMPM.format(date);
  }
  ...
  static String findMonthName(DateTime? dateTime ){
    return dateTime==null?"":_dateFormatetoMonth.format(dateTime);
  }
  static String calenderMothYearDate(DateTime? dateTime ){
    return dateTime==null?"":_calenderMothYearDate.format(dateTime);
  }

  static String calenderFullDate(DateTime? dateTime ){
    return dateTime==null?"":_calenderFullDate.format(dateTime);
  }
